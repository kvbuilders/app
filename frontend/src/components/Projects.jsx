    ...
    >
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-12 reveal">
          ...
          >
            <span className="text-amber-700 font-semibold text-sm">PORTFOLIO</span>
          </div>
          <h2
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              >
                {/* Image */}
                <div className="relative h-72 overflow-hidden img-hover">
                  <img
                    src={project.image}
                    alt={project.title}
                  ...
                  {/* Category Badge */}
                  <div
                    className="absolute top-4 left-4 px-4 py-2 rounded-full backdrop-blur-md text-white font-semibold text-sm"
                    style={{
